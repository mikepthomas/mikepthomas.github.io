declare module 'react-wow' {
    ...
    export interface IReactWOWProps {
        /**
         * Animation css class.
         *
         * Default: animated
         ...
         * Animation name.
         *
         * For examples see https://daneden.github.io/animate.css/
         */
        animation:
        // Attention Seekers
          "bounce" |
    ...
    /**
     * For examples see https://skyvow.github.io/react-wow/
     */
    export default class ReactWOW extends React.Component<IReactWOWProps, any> { 
    }
}
