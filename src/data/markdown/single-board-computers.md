...
| Generic ESP-WROOM-32E                                                                                                      | ESP32 Expansion Board                                                                                       |                                                                                                     |                   |                                     |
...
| Raspberry Pi Model B Rev 1 | 0002     | BCM2835 | 256MB | Adafruit Acrylic Case              | 8GB SD Card (TDK)           | Raspberry Pi OS Lite (Legacy, 32-bit) - Buster | raspberrypi | With [Adafruit RGB Negative 16x2 LCD](https://www.adafruit.com/product/1110) |
...
| Raspberry Pi 4 Model B V1.5 | c03115   | BCM2711 | 4GB | [Cluster HAT Case v3.0](https://thepihut.com/products/cluster-hat-case) | 128GB MicroSD (Integral)    | [Raspberry Pi OS Lite (Legacy, 64-bit) - Bullseye ClusterCTRL](https://github.com/burtyb/clusterhat-image) | cnat     | Boxed with [Cluster Hat v2.5](https://thepihut.com/products/cluster-hat-v2-0)                                      |
