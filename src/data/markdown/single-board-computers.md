...
| -------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ----------------- | ----------------------------------- |
| [Ai-Thinker ESP-01](https://docs.ai-thinker.com/en/esp8266/spec/esp_01)                                                    |                                                                                                             | [Ai-Thinker AT Firmware 0.9.5](https://docs.ai-thinker.com/en/%E5%9B%BA%E4%BB%B6%E6%B1%87%E6%80%BB) | AI-THINKER_D7A771 | Original ESP-01 for Wifi Arduino 85 |
| [Ai-Thinker ESP-01](https://docs.ai-thinker.com/en/esp8266/spec/esp_01)                                                    |                                                                                                             | [Ai-Thinker AT Firmware 0.9.5](https://docs.ai-thinker.com/en/%E5%9B%BA%E4%BB%B6%E6%B1%87%E6%80%BB) | AI-THINKER_D37617 | Original ESP-01 for Wifi Arduino 85 |
| [Ai-Thinker ESP-01](https://docs.ai-thinker.com/en/esp8266/spec/esp_01)                                                    |                                                                                                             | [Ai-Thinker AT Firmware 0.9.5](https://docs.ai-thinker.com/en/%E5%9B%BA%E4%BB%B6%E6%B1%87%E6%80%BB) | AI-THINKER_D3776D | Original ESP-01 for Wifi Arduino 85 |
| [Ai-Thinker ESP-01](https://docs.ai-thinker.com/en/esp8266/spec/esp_01)                                                    |                                                                                                             | [Ai-Thinker AT Firmware 0.9.5](https://docs.ai-thinker.com/en/%E5%9B%BA%E4%BB%B6%E6%B1%87%E6%80%BB) | AI-THINKER_D375BD | Original ESP-01 for Wifi Arduino 85 |
...
| Generic ESP-01s                                                                                                            | [Wifi Arduino 85](https://github.com/armtronix/Wifi-Arduino-85)                                             | [ESPHome](https://esphome.io/)                                                                      | relay-1           |                                     |
| Generic ESP-01s                                                                                                            | [Wifi Arduino 85](https://github.com/armtronix/Wifi-Arduino-85)                                             | [ESPHome](https://esphome.io/)                                                                      | relay-2           |                                     |
| Generic ESP-01s                                                                                                            | [Wifi Arduino 85](https://github.com/armtronix/Wifi-Arduino-85)                                             | [ESPHome](https://esphome.io/)                                                                      | relay-3           |                                     |
| Generic ESP-01s                                                                                                            | [Wifi Arduino 85](https://github.com/armtronix/Wifi-Arduino-85)                                             | [ESPHome](https://esphome.io/)                                                                      | relay-4           |                                     |
| Generic ESP-32 Cam                                                                                                         |                                                                                                             | [ESPHome](https://esphome.io/)                                                                      |                   |                                     |
...
| -------------------------- | -------- | ------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------- | ----------------------- | -------------------------------------------------------------------------------------------------- | -------- | ---------------------------------------------- |
| Raspberry Pi Zero V1.2     | 900092   | BCM2835 | 512MB | [Cluster HAT Case v3.0](https://thepihut.com/products/cluster-hat-case)                                                             |                         | [Raspberry Pi OS Lite (32-bit) - Bookworm ClusterCTRL](https://github.com/burtyb/clusterhat-image) | p1       | No Storage as it boots via USBBoot from `cnat` |
| Raspberry Pi Zero V1.3     | 900093   | BCM2835 | 512MB | [Cluster HAT Case v3.0](https://thepihut.com/products/cluster-hat-case)                                                             |                         | [Raspberry Pi OS Lite (32-bit) - Bookworm ClusterCTRL](https://github.com/burtyb/clusterhat-image) | p2       | No Storage as it boots via USBBoot from `cnat` |
| Raspberry Pi Zero W V1.1   | 9000c1   | BCM2835 | 512MB | [Cluster HAT Case v3.0](https://thepihut.com/products/cluster-hat-case)                                                             |                         | [Raspberry Pi OS Lite (32-bit) - Bookworm ClusterCTRL](https://github.com/burtyb/clusterhat-image) | p3       | No Storage as it boots via USBBoot from `cnat` |
| Raspberry Pi Zero W V1.1   | 9000c1   | BCM2835 | 512MB | [Cluster HAT Case v3.0](https://thepihut.com/products/cluster-hat-case)                                                             |                         | [Raspberry Pi OS Lite (32-bit) - Bookworm ClusterCTRL](https://github.com/burtyb/clusterhat-image) | p4       | No Storage as it boots via USBBoot from `cnat` |
